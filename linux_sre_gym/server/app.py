...
"""
FastAPI application for the Linux Sre Gym Environment.

This module creates an HTTP server that exposes the LinuxSreGymEnvironment
...
app = create_app(
    LinuxSreGymEnvironment,
    LinuxSreGymAction,
    LinuxSreGymObservation,
    env_name="linux_sre_gym",
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m linux_sre_gym.server.app
    ...
    multiple workers:
        uvicorn linux_sre_gym.server.app:app --workers 4
    """
    import uvicorn
